  ...
  return (
    <div className="max-w-2xl mx-auto grid grid-flow-row gap-6 py-12 text-center bg-brand text-white rounded-lg p-8">
      ...
      >
        ...
        <path
          opacity="0.5"
          d="M195.715 200.816C172.923 186.007 161.527 165.183 161.527 136.954C180.672 111.503 213.493 96 253.835 96C323.35 96 363.692 133.252 373.721 185.776H310.359C303.293 165.183 285.971 148.986 254.291 148.986C220.
          .33 148.986 197.311 169.116 195.715 200.816Z"
          fill="#F03E2F"
        />
      </svg>
      <OnboardingMessage
